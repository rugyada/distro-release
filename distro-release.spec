...
%endif
License:	GPLv2+
URL:		https://github.com/rugyada/distro-release
...
install -m 0644 desktops/Plasma/org.kde.plasma.desktop-defaults %{buildroot}%{_datadir}/plasma/shells/org.kde.plasma.desktop/contents/defaults
...
install -m 0644 desktops/Plasma/org.kde.plasma.desktop-defaults %{buildroot}%{_datadir}/plasma/layout-templates/org.openmandriva.plasma.desktop.defaultPanel/contents/defaults
